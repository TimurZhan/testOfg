...
public class NavigationHelper extends HelperBase {
  ...
  public void goToEditMailingAddress() {
    click(By.xpath("//div[@class='profile__col']/p[2]/a"));
  }

  public void goToEditFullName() throws InterruptedException {
    click(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[3]/div/div[1]/div/p[2]/a"));
    TimeUnit.SECONDS.sleep(2);
  }

  public void goToEditPhone() {
    click(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[3]/div/div[2]/div/p[2]/a"));
  }
  ...
  public void submitFront79() throws InterruptedException {
    ...
    assertThat(wd.findElement(By.xpath("//div[@id='content']/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div/div[1]/p[1]")).getText(),
            equalTo("170005, Бежецк, школьная, 85, корп/стр: 1, офис/кв: 1"));
    assertThat(wd.findElement(By.xpath("//div[@id='content']/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/p[1]")).getText(),
            equalTo("170005, Бежецк, школьная, 85, корп/стр: 1, офис/кв: 1"));
  }

  public void submitFront77() {
    waitTheElement(By.xpath("//div[@id='content']/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div/div[1]/p[1]"), "420095, Казань, ул Восход, 5, корп/стр: 3, офис/кв: 7");
    assertThat(wd.findElement(By.xpath("//div[@id='content']/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div/div[1]/p[1]")).getText(),
  ...
  public void submitFront78() {
    ...
    waitTheElement(By.xpath("//div[@id='content']/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/p[1]"), "140095, Тула, ул Восход, 67, корп/стр: 1, офис/кв: 94");
    assertThat(wd.findElement(By.xpath("//div[@id='content']/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/p[1]")).getText(),
  ...
  public void submitFront83() throws InterruptedException {
    ...
    assertThat(wd.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[3]/div/div[2]/div/h2")).getText(),
            equalTo("89021112255"));
  }
  ...
  public void signOut() throws InterruptedException {
    ...
    click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
    click(By.xpath("//div[@class='header-profile-nav-footer']/div/div[2]/span"));
    TimeUnit.SECONDS.sleep(1);
    //wd.navigate().refresh();
  }
  ...
  public void selectWorkflow() throws InterruptedException {
    click(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[4]/div/div[1]/div/div"));
    TimeUnit.SECONDS.sleep(2);
    click(By.xpath("//*[text()='Диадок']"));
    TimeUnit.SECONDS.sleep(2);
    assertThat(wd.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[4]/div/div[1]/div/div/div[1]/div[1]/div[2]")).getText(),
            equalTo("Диадок"));
    click(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[4]/div/div[1]/div/div"));
    TimeUnit.SECONDS.sleep(2);
  ...
  public void clickVAT() {
    ...
    click(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[4]/div/div[2]/div/div[1]/div"));
    assertThat(wd.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[4]/div/div[2]/div/div[1]/div")).getCssValue("background-color"),
            equalTo("rgba(0, 190, 106, 1)"));
    click(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[4]/div/div[2]/div/div[2]/div"));
    assertThat(wd.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div[4]/div/div[2]/div/div[2]/div")).getCssValue("background-color"),
            equalTo("rgba(0, 190, 106, 1)"));
  }
  ...
  public void checkingFormDocuments() throws InterruptedException {
    TimeUnit.SECONDS.sleep(5);
    click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
    click(By.xpath("//a[@href='/documents']"));
    click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
    TimeUnit.SECONDS.sleep(1);
  ...
  public void addCashRegister() {
    click(By.xpath("//a[@href='/downloads']"));
  }
  ...
  public void checkingCashMachinePage() {
    click(By.xpath("//div[@class='pos__head']/div[2]/p/span[2]/a"));
  ...
  public void goToEditAndAssertUpload() throws InterruptedException {
    ...
    assertThat(wd.findElement(By.xpath("//div[@class='fw-card-body']/div/div[4]/div/h4")).getText(),
            equalTo("Статистика отправки чеков по сообщениям и почте"));
    assertThat(wd.findElement(By.xpath("//div[@class='fw-card-body']/div/div[5]/div/h4")).getText(),
            equalTo("Аренда"));
    assertThat(wd.findElement(By.xpath("//div[@class='fw-card-body']/div/div[7]/h4")).getText(),
  ...
  public void clickTabsMainPage() throws InterruptedException {
    ...
    click(By.xpath("//button[@class='header__btn_menu']"));
    TimeUnit.SECONDS.sleep(1);
    ...
    assertThat(wd.findElement(By.xpath("//div[@class='section']/div[3]/h1")).getText(),
            equalTo("Программный интерфейс приложений (API) для сверки документов с оператором фискальных данных OFD.RU"));
    click(By.xpath("//a[@class='btn btn-border-fade pull-right']"));
    TimeUnit.SECONDS.sleep(1);
  ...
  public void checkPartnersPage() throws InterruptedException {
    click(By.linkText("Партнёрам"));
    assertThat(wd.findElement(By.cssSelector("button.btn-standart span.mat-button-wrapper")).getText(),
            equalTo("СТАТЬ ПАРТНЁРОМ"));
    click(By.xpath("//a[@class='logo']"));
    TimeUnit.SECONDS.sleep(2);
  }
  ...
  public void checkEmailRegistrationForm() throws InterruptedException {
    ...
    type1(By.name("RepeatPassword"), "12345");
    click(By.xpath("//button[@class='btn btn-primary btn-shadow ofd-form__button analytics-regstep1']"));
    TimeUnit.SECONDS.sleep(2);
  ...
  public void confirmationRegistration(String email, String password) throws InterruptedException {
    TimeUnit.SECONDS.sleep(2);
    type(By.xpath("//input[@id='Login']"), email);
    type(By.xpath("//input[@id='Password_lk_main']"), password);
    click(By.xpath("//form[@id='forma_lk']//button[@type='submit']"));
  ...
  public void replaceForgotPassword1(String email) throws InterruptedException {
    click(By.xpath("//div[@class='login-wide-links']/span[2]"));
    TimeUnit.SECONDS.sleep(2);
    type1(By.xpath("//input[@id='emailChangePasswordDialog']"), email);
    TimeUnit.SECONDS.sleep(2);
    click(By.xpath("//button[@class='fw-btn fw-btn_md fw-btn-primary fw-btn_index font-size-16 fd-width-240']"));
    TimeUnit.SECONDS.sleep(2);
    click(By.xpath("//button[@class='material-icons']"));
  }

  public void replaceForgotPassword2(String email) throws InterruptedException {
    click(By.xpath("//div[@class='fw-col fw-col-1 loginForm fw-col-xs-1']/a[2]"));
    TimeUnit.SECONDS.sleep(2);
    type1(By.xpath("//input[@placeholder='E-Mail']"), email);
    TimeUnit.SECONDS.sleep(2);
    click(By.xpath("//button[@class='btn btn-shadow btn-primary btn-sm']"));
    TimeUnit.SECONDS.sleep(2);
    click(By.xpath("//div[@id='Modal-user-change_pass']//div[@type='button']"));
  }
   ...
   public void confirmForgotPassword(String email, String password2) throws InterruptedException {
     ...
     click(By.xpath("//button[@class='fw-btn fw-btn_md fw-btn-primary fw-btn_primary-border width-100 font-size-18 opacity-50']"));
     TimeUnit.SECONDS.sleep(2);
     assertThat(wd.findElement(By.xpath("/html/body/div[1]/div/div/div[2]/div/div/h2")).getText(), equalTo("Регистрация данных пользователя"));
     click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
     TimeUnit.SECONDS.sleep(1);
  ...
  public void enterBecomePartner() throws InterruptedException {
    wd.get("https://pk-dev.ofd.ru/main");
    TimeUnit.SECONDS.sleep(2);
    click(By.xpath("//section[@class='promo__banner']//button[1]"));
  }
  ...
  public void fillingRegFieldsNewPartner(String email, String password) throws InterruptedException {
    TimeUnit.SECONDS.sleep(3);
    type1(By.xpath("//input[@formcontrolname='email']"), email);
    type1(By.xpath("//input[@formcontrolname='phone']"), "9054001020");
    type1(By.xpath("//input[@formcontrolname='fullName']"), "Test Testov");
    click(By.xpath("//mat-icon[@class='icon mat-icon material-icons']"));
  ...
  public void addAdditionalUser2(String email) throws InterruptedException {
    ...
    click(By.xpath("/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div[2]/p/button"));
    type1(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div[1]/div[2]/div/div[2]/div[1]/div/div/input"), email);
    click(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[2]/div[1]/div[2]/div/div[2]/div[2]/div/div/input"));
    TimeUnit.SECONDS.sleep(3);
    ...
    assertThat(wd.findElement(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div[1]/div[2]/div/div[2]/div[3]/div/div/input")).
                    getCssValue("color"), equalTo("rgba(134, 171, 193, 1)"));
    assertThat(wd.findElement(By.xpath("//div[@class='users__dialog-container-inner']//p[@class='fd-text fd-text_center fd-text_m fd-text_green ']")).getText(),
  ...
  public void checkRemoveAccess() throws InterruptedException {
    ...
    click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
    TimeUnit.SECONDS.sleep(1);
    click(By.xpath("//div[@class='fd-table']/div[4]/div/div[1]"));
    TimeUnit.SECONDS.sleep(2);
    ...
    new WebDriverWait(wd, 1).
            until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[3]/div/div/div/div[4]/div/div[3]/div/i")));
    new WebDriverWait(wd, 1).
            until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[3]/div/div/div/div[4]/div/div[4]/div/i")));
    new WebDriverWait(wd, 1).
            until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[3]/div/div/div/div[4]/div/div[5]/div/i")));
    click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
    TimeUnit.SECONDS.sleep(1);
    click(By.xpath("//a[@href='/users']"));
    click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
    ...
    click(By.xpath("/html/body/div[1]/div/div/div[2]/div[1]/div[1]/div/div[1]/i"));
    new WebDriverWait(wd, 1).
            until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[3]/div/div/div/div[4]/div/div[3]/div/i")));
    new WebDriverWait(wd, 1).
            until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[3]/div/div/div/div[4]/div/div[4]/div/i")));
    new WebDriverWait(wd, 1).
            until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[3]/div/div/div/div[4]/div/div[5]/div/i")));
    TimeUnit.SECONDS.sleep(1);
    click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
    click(By.xpath("//div[@class='header-profile-nav-footer']/div/div[2]/span"));
    TimeUnit.SECONDS.sleep(1);
  ...
  public void checkAccessUserAccount() throws InterruptedException {
    ...
    if (isElementPresent(By.xpath("//div[@class='fw-notification-close']"))){
      ...
      TimeUnit.SECONDS.sleep(1);
      assertThat(wd.findElement(By.xpath("//div[@class='pull-left']/a[@href='/pos-list']")).getText(),
              equalTo("Мои кассы"));
      assertThat(wd.findElement(By.xpath("//div[@class='pull-left']/a[@href='/downloads']")).getText(),
              equalTo("Отчёты"));
      assertThat(wd.findElement(By.xpath("//a[@href='/fnsreg']")).getText(),
              equalTo("Заявки в ФНС"));
      assertThat(wd.findElement(By.xpath("//a[@href='/support']")).getText(),
              equalTo("Поддержка"));
      assertThat(wd.findElement(By.xpath("//a[@href='/partner-services']")).getText(),
              equalTo("Заказать услугу"));
      click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
      TimeUnit.SECONDS.sleep(1);
      assertThat(wd.findElement(By.xpath("//a[@href='/documents']")).getText(),
              equalTo("Документы"));
      assertThat(wd.findElement(By.xpath("//a[@href='/profile']")).getText(),
              equalTo("Профиль"));
      click(By.xpath("//div[@class='navbar-item header-toggle fd-pointer']"));
      TimeUnit.SECONDS.sleep(1);
      click(By.xpath("//a[@href='/downloads']"));
  ...
  public void authAccountManager(String email, String password) throws InterruptedException {
    wd.get("https://mk-dev.ofd.ru/login");
    TimeUnit.SECONDS.sleep(6);
    type1(By.id("Login"), email);
  ...
  public void checkClientsTab() throws InterruptedException {
    wd.get("https://dev.ofd.ru/mk/clients");
    //wd.manage().window().maximize();
    TimeUnit.SECONDS.sleep(5);
  ...
  public void checkAddNewUserIndividMerch(String email, String inn) throws InterruptedException {
    TimeUnit.SECONDS.sleep(3);
    wd.get("https://mk-dev.ofd.ru/clients");
    //wd.manage().window().maximize();
    TimeUnit.SECONDS.sleep(8);
    click(By.cssSelector("div.ofd-text_right button.ofd-button"));
    type1(By.id("Inn"), inn);
    TimeUnit.SECONDS.sleep(1);
  ...
  public void registOnNewsTab(String email,String password) throws InterruptedException {
    ...
    click(By.xpath("//form[@class='ofd-form']/div[2]/button"));
    TimeUnit.SECONDS.sleep(3);
    assertThat(wd.findElement(By.xpath("//a[@href='/logout?login=true']")).getText(),
            equalTo("подключится под другим пользователем"));
    TimeUnit.SECONDS.sleep(1);
  }
  ...
  public void registInvalidEmail(String password) throws InterruptedException {
    ...
    type(By.id("FullName"), "Юер Течт");
    click(By.xpath("//div[@id='pass_view_reg']/i[1]"));
    type(By.id("Password_reg"), password);
    click(By.xpath("//button[@type='submit']"));
    TimeUnit.SECONDS.sleep(1);
    assertThat(wd.findElement(By.xpath("//div[@data-form-error='Email']")).getText(),
            equalTo("Неверный формат E-Mail"));
  ...
  public void checkBuySmsNotMoney() throws InterruptedException {
    ...
    click(By.xpath("//div[@class='fw-card-body']//div[@class='fd-select__current']"));
    TimeUnit.SECONDS.sleep(1);
    click(By.xpath("//*[text()='Свой, от 1000 чеков по 1.65р за чек']"));
    TimeUnit.SECONDS.sleep(1);
    type1(By.xpath("//input[@class='fd-input__field  ']"), "3424234");
  ...
  public void balanceCheck() throws InterruptedException {
    TimeUnit.SECONDS.sleep(5);
    wd.get("https://pk-dev.ofd.ru/");
    TimeUnit.SECONDS.sleep(5);
    click(By.xpath("//div[@class='mat-toolbar-layout']//button[@class='mat-button']"));
    TimeUnit.SECONDS.sleep(1);
    click(By.xpath("//ul[@class='header-profile-nav-accounts']/li[20]"));
    TimeUnit.SECONDS.sleep(5);
    click(By.xpath("//a[@href='/balance']"));
  ...
  public void generalPageCheck() throws InterruptedException {
    ...
    click(By.xpath("//div[@class='mat-toolbar-layout']//button[@class='mat-button']"));
    TimeUnit.SECONDS.sleep(1);
    click(By.xpath("//ul[@class='header-profile-nav-accounts']/li[21]"));
    TimeUnit.SECONDS.sleep(3);
    ...
    assertThat(wd.findElement(By.xpath("//span[@class='companyname']")).getText(),
            equalTo("ЗАО \"РИКОН\""));
    type(By.name("searchString"), "копыта\n");
    TimeUnit.SECONDS.sleep(2);
    assertThat(wd.findElement(By.xpath("//span[@class='companyname']")).getText(),
  ...
  public void createNewUser(String email, String inn) throws InterruptedException {
    ...
    click(By.xpath("//div[@class='mat-toolbar-layout']//button[@class='mat-button']"));
    TimeUnit.SECONDS.sleep(1);
    click(By.xpath("//ul[@class='header-profile-nav-accounts']/li[2]"));
    TimeUnit.SECONDS.sleep(5);
    click(By.xpath("//a[@href='/clients']"));
  ...
  public void checkHelpOldUser()throws InterruptedException {
    ...
    TimeUnit.SECONDS.sleep(2);
    click(By.xpath("//*[text()='OOO PHOENIX']"));
    TimeUnit.SECONDS.sleep(5);
    click(By.xpath("//*[text()='yaschenko@ofd.ru']"));
    TimeUnit.SECONDS.sleep(1);
    click(By.xpath("//ul[@class='header-profile-nav-links']/li[3]"));
    TimeUnit.SECONDS.sleep(4);
    assertThat(wd.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[1]/div/div[1]/div[2]/span/span")).getText(),
              equalTo("Ваши закрывающие документы"));
  ...
  public void checkHelpNewUser()throws InterruptedException {
    ...
    assertThat(wd.findElement(By.xpath("//div[@class='fw-card-body']/div[1]/span[1]")).getText(),
            equalTo("В личном кабинете для вас доступны закрывающие документы за прошедшие периоды."));
    click(By.xpath("//div[@class='fw-card-footer ']/div/a"));
    TimeUnit.SECONDS.sleep(1);
  ...
  public void checkProfileEmployees(String email2) throws InterruptedException {
    TimeUnit.SECONDS.sleep(3);
    wd.get("https://pk-dev.ofd.ru/employees");
    TimeUnit.SECONDS.sleep(7);
